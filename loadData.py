...
class DataSet():
    def __init__(self, num=4000, testnum=2000, img_size=64, batch_size=128, category='Fashion-Mnist'):
        self.img_size = img_size
        self.batch_size = batch_size
        self.num = num
        self.testnum = testnum
        self.category = category
        self.data, self.test_data, self.labels, self.test_labels = self.Load()
    ...
    def Load(self):
        ...
        if self.category == 'Mnist':
            ...
            data = train_images[:self.num]
            label = train_labels[:self.num]
            test_data = test_images[:self.testnum]
            test_label = test_labels[:self.testnum]
